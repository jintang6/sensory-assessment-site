...
cp "$PROJECT_DIR/team.html" "$BUILD_DIR/team.html"
cp "$PROJECT_DIR/team.css" "$BUILD_DIR/team.css"
cp "$PROJECT_DIR/team.js" "$BUILD_DIR/team.js"
cp "$PROJECT_DIR/report-docx.js" "$BUILD_DIR/report-docx.js"
cp "$PROJECT_DIR/shared-report.html" "$BUILD_DIR/shared-report.html"
